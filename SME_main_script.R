##########
# main script for the metacommunity dynamics
##########

source("SME_InteractionTopology.R")
source("SME_SignMatrix.R")
source("SME_InteractionCoefs.R")
source("SME_Metacommunity.R")
source("SME_MovementMatrix.R")
...
# in the paper, the configurations used are 6,7, and 11
# i.e. linear topology, only antagonism, constant dispersal and/or foraging
ID <- 11
